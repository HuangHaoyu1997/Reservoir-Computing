...
def add_training_options(parser):
    ...
    parser.add_argument("--lr",                   type=float,  default=1e-2,             help="Initial learning rate for training. The default value of 0.01 is good for SHD and SC, but 0.001 seemed to work better for HD and SC.",)
