...
def train(trial:int, model:RC, optimizer, criterion, num_epochs, train_loader, test_loader, scheduler):
    ...
    cin = ((model.alpha.view(8, 16) - model.alpha.view(8, 128).mean(0))**2).mean() # 簇内聚
    ...
    for e in range(1, num_epochs+1):
        ...
        cin = ((model.alpha.view(8, 128) - model.alpha.view(8, 128).mean(0))**2).mean() # 簇内聚
        cout = model.alpha.view(8, 128).mean(0).std() # 簇外散
