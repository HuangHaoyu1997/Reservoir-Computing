...
def train(trial, model, optimizer, criterion, num_epochs, train_loader, test_loader, ts_acc):
    model.train()
...
def multiple_trial():
    ...
    for i in range(config.trials):
        ...
        train_acc, test_acc = train(i, model, optimizer, criterion, config.nb_epochs, train_loader, test_loader)
