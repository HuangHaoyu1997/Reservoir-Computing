...
def train(trial, model, optimizer, criterion, num_epochs, train_loader, test_loader, scheduler):
    ...
    for e in range(num_epochs):
        ...
        ts_acc, ts = test(model, test_loader, mask, criterion)
        ...
        logging.info(f"Epoch {e}: tr loss={tr_loss:.4f}, te loss={te_loss:.4f}, acc={tr_acc:.4f}, fr={epoch_spike_rate:.4f}, lr={current_lr:.4f}, time={elapsed}")
        logging.info("\n-----------------------------\n")
